...
%%%%----首页信息设置----%%%%
\title[ 厦门大学 Beamer 模板]{厦门大学 Beamer 模板}
\subtitle{——这里是副标题}			
%%%%----标题设置
...
\author[Yanmei Nie]{
 聂艳梅 \\\medskip
  {\small \url{nieyanmeihcs@163.com}} \\
  {\small \url{https://www.xmu.edu.cn/}}}
%%%%----个人信息设置
...
\begin{frame}
  ...
  \begin{itemize}
    \item {编译方式}
	    \begin{itemize}
	    	\item  推荐安装完整版的 TeXLive or MacTex
	    	\item 使用 \XeLaTeX 编译
	    \end{itemize}
    ...
    \end{equation}	 }   
    \item 基于“厦大”颜色 \url{https://www.xmu.edu.cn/}
  \end{itemize}
\end{frame}
